...
const empOne = new Employee('Jesse', 'Tuesday evenings and weekends')
...
const manager = new Manager('Johnathan', 'weekday mornings and weekday evenings', ['Jesse', 'Skyler'])
